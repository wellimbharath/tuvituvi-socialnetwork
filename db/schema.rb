...
ActiveRecord::Schema.define(version: 20170421054511) do
  ...
  create_table "networks", force: :cascade do |t|
    t.string   "network_name", limit: 255
    t.datetime "created_at",               null: false
    t.datetime "updated_at",               null: false
  end
  ...
  add_index "user_networks", ["state"], name: "index_user_networks_on_state", using: :btree
  add_index "user_networks", ["user_id", "friend_id"], name: "index_user_networks_on_user_id_and_friend_id", using: :btree
  ...
  add_index "users", ["terms"], name: "index_users_on_terms", using: :btree
